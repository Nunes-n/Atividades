...
public class DaoHotel {
    ...
    public Hotel consultar (int codigo) {
        ...
        try {
            ...
            if (rs.next()) {
                objHot = new Hotel(rs.getInt("Codigo_Hot"),rs.getString("Nome_Hot"));
    ...
    public void inserir(Hotel objHot) {
        PreparedStatement ps;
        try {
            ps = conn.prepareStatement("INSERT INTO tblHotel(Codigo_Hot, Nome_Hot, Endereco_Hot, Telefone_Hot, ValorDiaria_Hot) VALUES(?,?,?,?,?)");
            ps.setInt(1, objHot.getCodigo());
            ps.setString(2, objHot.getNome());
            ps.setString(3, objHot.getEndereco());
            ps.setString(4, objHot.getTelefone());
            ps.setDouble(5, objHot.getValorDiaria());
